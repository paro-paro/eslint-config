...
export function overrides(ctx: Context): FlatConfigItem[] {
  const {
    enableTs = true,
    enableJson = true,
  ...
  const markdownCode: FlatConfigItem = {
    files: enableTs
      ? [...GLOB_MD_CODE_TS]
      : [...GLOB_MD_CODE_JS],
